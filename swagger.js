const options = {
  ...
  const swaggerDocument = {
    info: {
      version: "1.0.0",
      title: "Pariksha mitra API",
      description: "API for Managing Pariksha mitra calls",
      contact: {
        name: "Tamanjeet and Anish Rawat",
        email: "tehritaman27@gmail.com",
      },
    },
    host: "localhost:3000",
    basePath: "/",
    ...
    tags: [
      {
        name: "Pariksha mitra CRUD",
        description: "Pariksha mitra related apis",
      },
      {
        name: "Pariksha mitra",
        description: "Pariksha mitra App",
      },
    ],
    securityDefinitions: {},
    definitions: {
